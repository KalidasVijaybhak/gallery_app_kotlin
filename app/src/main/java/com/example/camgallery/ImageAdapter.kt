package com.example.camgallery
 import com.example.camgallery.ImageFullActivity
...
class ImageAdapter( private var context: Context, private  var imagesList:ArrayList<Image1>) :RecyclerView.Adapter<ImageAdapter.ImageViewHolder>(){
